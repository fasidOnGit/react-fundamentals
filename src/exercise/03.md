...
Learned that babel can transpile JSX on the fly. got a fair idea about how the
transformed code from JSX -> React.createElement would look like. Also learned
that we can spread props in JSX
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=fasidmpm%40gmail.com).
