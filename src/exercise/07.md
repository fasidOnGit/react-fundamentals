...
Learned about `key` prop that. it is neeed for React to keep track of elements,
especially helps react in maintaining state. Not providing it can give mixed up
behaviour. Also, learned that the default behaviour itself is using array's
index. and it's unlikely to fix this problem.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=fasidmpm%40gmail.com).
