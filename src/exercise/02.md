...
I learned that we can nest elements in `React.createElement`. Most importantly, I know understand the reason between *why* `React` and `ReactDOM`. 
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=fasidmpm%40gmail.com).
